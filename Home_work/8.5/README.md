...
TASK [Destroy molecule instance(s)] ********************************************
changed: [localhost] => (item={'image': 'docker.io/library/centos:centos7.9.2009', 'name': 'centos7', 'pre_build_image': True})

TASK [Wait for instance(s) deletion to complete] *******************************
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': '995854164756.804', 'results_file': '/root/.ansible_async/995854164756.804', 'changed': True, 'item': {'image': 'docker.io/library/centos:centos7.9.2009', 'name': 'centos7', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
...
TASK [Create Dockerfiles from image names] *************************************
skipping: [localhost] => (item="Dockerfile: None specified; Image: docker.io/library/centos:centos7.9.2009")
skipping: [localhost]
...
skipping: [localhost] => (item=docker.io/library/centos:centos7.9.2009)
skipping: [localhost]
